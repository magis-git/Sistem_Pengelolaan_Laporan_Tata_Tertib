...
<?php $__env->startSection('title'); ?> Edit Kelas <?php $__env->stopSection(); ?> 
                ...
                <div class="col-12 col-lg-15">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" class="bg-white shadow-sm p-3" action="<?php echo e(route('kelas.update', [$kelas->id])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" value="PUT" name="_method">
                                <label for="kelas_number">Kelas</label>
                                <input
                                value="<?php echo e($kelas->kelas_number); ?>" 
                                ...
                                <input
                                value="<?php echo e(old('kelas_name', $kelas->kelas_name)); ?>"
                                ...
                                <input
                                value="<?php echo e(old('walikelas_1', $kelas->walikelas_1)); ?>" 
                                ...
                                <input
                                value="<?php echo e(old('walikelas_2', $kelas->walikelas_2)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kurumi\SMPIT-Bina-Amal\resources\views/kelas/edit.blade.php ENDPATH**/ ?>