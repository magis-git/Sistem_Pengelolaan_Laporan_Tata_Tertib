        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" class="bg-white shadow-sm p-3" action="<?php echo e(route('verification.update', [$violation->id])); ?>" method="POST"
...
<?php echo $__env->make('layouts.global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kurumi\SMPIT-Bina-Amal\resources\views/verification/edit.blade.php ENDPATH**/ ?>