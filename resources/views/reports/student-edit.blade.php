        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" class="bg-white shadow-sm p-3" action="{{route('reports.student-update', [$student->id])}}" method="POST"
