...
@section('title') Edit Pelanggaran @endsection 
                ...
                <div class="col-12 col-lg-15">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" class="bg-white shadow-sm p-3" action="{{route('violation.update', [$violation->id])}}" method="POST">
                                @csrf
                                ...
                                <label for="violation_level">
                                    ...
                                    <select class="block w-full mt-1" name="violation_level">
                                        <option value=" " class="form-control {{$errors->first('violation_level') ? "is-invalid": ""}}">Select User Level</option>
